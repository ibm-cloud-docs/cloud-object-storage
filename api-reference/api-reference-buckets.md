...
## List Aspera service access api key for a bucket

A `GET` issued to a bucket with the proper parameters retrieves Aspera service access api key for a bucket.
