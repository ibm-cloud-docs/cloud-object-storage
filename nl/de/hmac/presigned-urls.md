...
Vorsignierte URLs erstellen einen temporären Link, mit dem Sie ein Objekt zur gemeinsamen Nutzung freigeben oder ein [Ziel vorübergehend zum Senden einer PUT-Anforderung bereitstellen](https://medium.com/codait/keeping-your-secrets-between-cloud-object-storage-and-your-browser-part-1-68f4b83bbd38) können, ohne dass hierzu Authentifizierungsinformationen angegeben werden müssen.

Die einfachste Art der Erstellung von vorsignierten URLs erfordert die Verwendung der [AWS-Befehlszeilenschnittstelle](/docs/services/cloud-object-storage/cli?topic=cloud-object-storage-aws-cli) (AWS-CLI):
...
Signierte URLs können auch programmgesteuert erzeugt werden. Die nachfolgenden Beispiele veranschaulichen grundlegende, in Python geschriebene `GET`-Operationen. Weitere Informationen zu Endpunkten enthält [Endpunkte und Speicherpositionen](/docs/services/cloud-object-storage?topic=cloud-object-storage-endpoints#endpoints).
...
expiration = 86400  # Zeit in Sekunden
...
# Da COS anders als AWS keine Regionen verwendet, akzeptiert dieser Parameter jede beliebige Zeichenkette
...
# Diese Informationen können bei der Fehlersuche hilfreich sein oder zum Verständnis
# der einzelnen  Schritte bei der Erstellung von Signaturen beitragen
...
public class CoSHMAC {
    ...
    private static final int expiration = 86400;  // Zeit in Sekunden
...
## Vorsignierte URL zum Hochladen eines Objekts erstellen
