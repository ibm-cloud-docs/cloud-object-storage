...
Los URL prefirmados crean un enlace temporal que se puede utilizar para compartir un objeto de forma pública o para [proporcionar un destino temporal para enviar una solicitud PUT](https://medium.com/codait/keeping-your-secrets-between-cloud-object-storage-and-your-browser-part-1-68f4b83bbd38) sin necesidad de proporcionar información de autenticación.

La forma más fácil de crear los URL prefirmados es utilizar la [CLI de AWS](/docs/services/cloud-object-storage/cli?topic=cloud-object-storage-aws-cli):
...
También se pueden crear mediante programación. A continuación se muestran ejemplos de operaciones `GET` básicas escritas en Python. Para obtener más información sobre puntos finales, consulte [Puntos finales y ubicaciones de almacenamiento](/docs/services/cloud-object-storage?topic=cloud-object-storage-endpoints#endpoints).

## Creación de un URL prefirmado para descargar un objeto
{: #presign-url-get}
...
# la región es un valor comodín que ocupa el lugar del valor de la región de AWS
# ya que COS no utiliza regiones como AWS, este parámetro acepta cualquier serie
...
# esta información puede resultar de ayuda para solucionar problemas o para comprender mejor
# lo que implica la creación de una firma
...
public class CoSHMAC {
    ...
    // ya que COS no utiliza el mismo convenio de regiones, este parámetro acepta cualquier serie
...
## Creación de un URL prefirmado para cargar un objeto
...
function printDebug() {
    // esta información puede resultar útil para solucionar problemas o para comprender mejor
    // lo que implica la creación de una firma
