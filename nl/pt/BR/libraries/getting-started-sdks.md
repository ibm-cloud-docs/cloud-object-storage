...
Neste guia de iniciação rápida, é fornecido um exemplo de código que demonstra as operações a seguir:

* Criar um novo depósito
* Listar os depósitos disponíveis
* Criar um novo arquivo de texto
* Listar os arquivos disponíveis
* Recuperar o conteúdo do arquivo de texto
* Fazer upload de um arquivo binário grande
* Excluir um arquivo
* Excluir um depósito
...
* Uma [Conta do {{site.data.keyword.cloud}} Platform](https://cloud.ibm.com/login)
...
* Uma [Chave de API do IAM](/docs/services/cloud-object-storage/iam?topic=cloud-object-storage-iam-overview) com acesso de Gravador para seu {{site.data.keyword.cos_short}}

## Obtendo o SDK
{: #sdk-gs-install}

Instruções específicas para fazer download e instalar o SDK estão disponíveis em [Usando Python.](/docs/services/cloud-object-storage/libraries?topic=cloud-object-storage-python){:new_window}{: python}[Usando Node.js.](/docs/services/cloud-object-storage/libraries?topic=cloud-object-storage-node){:new_window}{: javascript}[Usando Java.](/docs/services/cloud-object-storage/libraries?topic=cloud-object-storage-java){:new_window}{: java}[Usando Go.](/docs/services/cloud-object-storage/libraries?topic=cloud-object-storage-go){:new_window}{: go}

## Exemplo de código
{: #sdk-gs-example}

Os exemplos de código abaixo fornecem exemplos introdutórios de execução das operações básicas com o {{site.data.keyword.cos_short}}. Para simplificar, o exemplo de código pode ser executado várias vezes à medida que usa identificadores exclusivos universais (UUIDs) para nomes de depósito/item para evitar potenciais conflitos.

Para concluir o exemplo de código, é necessário substituir os valores a seguir:

|Valor|Descrição|Exemplo|
|---|---|---|
|`<endpoint>`|O terminal regional para sua instância do COS|`s3.us-south.cloud-object-storage.appdomain.cloud`|
|`<api-key>`|A chave de API do IAM com pelo menos permissões `Writer`|`xxxd12V2QHXbjaM99G9tWyYDgF_0gYdlQ8aWALIQxXx4`|
|`<resource-instance-id>`|O ID exclusivo para a instância de serviço|`crn:v1:bluemix:public:cloud-object-storage:global:a/xx999cd94a0dda86fd8eff3191349999:9999b05b-x999-4917-xxxx-9d5b326a1111::`|
|`<storage-class>`|A classe de armazenamento para um novo depósito|`us-south-standard`|
...
Para executar a amostra de código, copie os blocos de códigos acima e execute o seguinte:
```
...
A saída do Exemplo de código deve ser semelhante à seguinte:
