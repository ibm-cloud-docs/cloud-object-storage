...
| `jp-tok`   | Yes    | Yes         | Yes (see note)                 | Yes          | Yes                      | `ap-tok`         | Yes       | Yes        | `ap-tok`   |
...
| `ca-tor`   | No     | Yes         | Yes (see note)                 | Yes          | Yes                      | `ca-tor`         | Yes       | Yes        | `ca-tor`   |
| `br-sao`   | No     | Yes         | Yes (see note)                 | Yes          | Yes                      | `br-sao`         | Yes       | Yes        | `br-sao`   |
