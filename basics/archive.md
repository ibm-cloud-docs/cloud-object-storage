...
![Create an archive policy](https://docs-resources.s3.us.cloud-object-storage.appdomain.cloud/bucket-create-ui-archive-rule.png){: caption="Figure 1. Create an archive policy"}
