...
Customers that use hardcoded IP addresses for {{site.data.keyword.IBM_notm}} {{site.data.keyword.cos_short}} endpoints within their workloads, firewalls, or security components might be affected when new IP addresses are used.

**Action may be required.** This change affects you when accessing Object Storage:
- By using an IP address (rather than URL)
...
| Sao Paulo (br-sao)   | October 10, 2024                    | October 24, 2024                  |
...
| Sao Paulo (br-sao) public    |  s3.br-sao.cloud-object-storage.appdomain.cloud           | 13.116.118.49  | 13.116.118.49, 13.116.118.54, 13.116.118.55      |
| Sao Paulo (br-sao) private   |  s3.private.br-sao.cloud-object-storage.appdomain.cloud   | 10.1.129.165   | 10.1.129.165, 10.1.129.191, 10.1.129.192         |
| Sao Paulo (br-sao) direct    |  s3.direct.br-sao.cloud-object-storage.appdomain.cloud    | 161.26.0.96    | 161.26.0.96, 161.26.205.96, 161.26.209.96        |
