...
Downloads using Aspera high-speed incur additional egress charges. For more information, see the [pricing page](https://console.bluemix.net/docs/services/cloud-object-storage/help/billing.html#billing).
