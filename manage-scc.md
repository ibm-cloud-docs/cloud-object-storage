...
To start monitoring your resources, check out [Getting started](/docs/security-compliance?topic-security-compliance-getting-started) for {{site.data.keyword.compliance_short}}.
