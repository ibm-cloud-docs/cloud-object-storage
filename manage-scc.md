...
| *bucket*      | *storage_class*                                        | string`       | Cloud Object Storage bucket storage class. This field is case-sensitive and is configured during bucket creation in the `LocationConstraint` field. [See here for details](/docs/cloud-object-storage?topic=cloud-object-storage-classes#classes-locationconstraint).                                                                                                              |
