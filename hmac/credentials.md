...
Users can create a set of HMAC credentials by creating a [Service Credential](/docs/services/cloud-object-storage/iam/service-credentials.html).  These HMAC keys are then associated with a [Service ID](/docs/services/cloud-object-storage/iam/users-serviceids.html) and can be used to access any resources or operations allowed by the Service ID's role.
