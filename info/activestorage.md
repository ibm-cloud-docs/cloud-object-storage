...
[Rails](https://guides.rubyonrails.org/getting_started.html){:new_window} is an open source, web application development framework. It includes everything that is needed to create server-side web applications that use the Model-View-Controller (MVC) pattern. 
