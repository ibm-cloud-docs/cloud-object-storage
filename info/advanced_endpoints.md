...
* **Direct endpoints** can accept requests from within the VPC and charges are assessed on outgoing bandwidth. Incoming bandwidth is free. Use direct endpoints to connect from a VPC to Cloud Object Storage.
