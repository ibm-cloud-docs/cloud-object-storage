...
| `cloud-object-storage.object.get_torrent_version`                | Get headers for a specific torrent version of an object.                            | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_torrent_version_id`             | Get headers for a specific torrent version id of an object.                            | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
