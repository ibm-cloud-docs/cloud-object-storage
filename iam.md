...
| `cloud-object-storage.bucket.get_versions`                       | List object versions.                                                               | [prefix, delimeter](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-prefix-delimeter)       |
| `cloud-object-storage.bucket.get_uploads`                        | List all active multipart uploads for a bucket.                                     | [prefix, delimeter](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-prefix-delimeter)       |
...
| `cloud-object-storage.object.head_torrent`                       | Get headers for a specific torrent of an object.                                    | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
...
| `cloud-object-storage.object.post_initiate_upload`               | Initiate multipart uploads.                                                         | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_part`                           | Upload an object part.                                                              | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy_part`                          | Copy (write) an object part.                                                        | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy_part_get`                      | Copy (read) an object part.                                                         | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy_part_get_version`              | Copy (read) an object part.                                                         | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.post_complete_upload`               | Complete a multipart upload.                                                        | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy`                               | Copy (write) an object from one bucket to another.                                  | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy_get`                           | Copy (read) an object from one bucket to another.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.copy_get_version`                   | Copy (read) an object from one bucket to another.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_acl`                            | Read object ACL [deprecated].                                                       | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_acl_version`                    |                                                                                     | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_acl`                            | Write object ACL [deprecated].                                                      | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_acl_version`                    | Unsupported operation - used for S3 API compatibility only.                         | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.delete`                             | Delete an object.                                                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.delete_version`                     | Delete a specific version of an object.                                             | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_uploads`                        | List parts of an object.                                                            | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.delete_upload`                      | Abort a multipart upload.                                                           | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.restore`                            | Temporarily restore an archived object.                                             | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.restore_version`                    | Temporarily restore an archived object.                                             | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
...
| `cloud-object-storage.object.get_object_lock_retention`          | Get object lock retention settings on the object.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_object_lock_retention`          | Set object lock retention settings on the object.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_object_lock_legal_hold`         | Get object lock legal hold state on the object.                                     | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_object_lock_legal_hold`         | Set object lock legal hold state on the object.                                     | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_object_lock_retention_version`  | Get object lock retention settings on the object.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_object_lock_retention_version`  | Set object lock retention settings on the object.                                   | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.post_extend_retention`              | Extend a retention policy.                                                          | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.get_object_lock_legal_hold_version` | Get object lock legal hold state on the object.                                     | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
| `cloud-object-storage.object.put_object_lock_legal_hold_version` | Set object lock legal hold state on the object.                                     | [path](/docs-draft/cloud-object-storage?topic=cloud-object-storage-fgac-iam-access-conditions&interface=ui#fgac-attributes-path)           |
